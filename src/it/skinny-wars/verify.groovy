...
if ( !manifestClassPath.equals("commons-lang-commons-lang-2.6.jar") )
{
    throw new IllegalStateException( "Missing entry in war MANIFEST.MF: commons-lang-commons-lang-2.6.jar");
}
